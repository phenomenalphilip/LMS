...
import { CreditCard, Lock, ArrowRight, CheckCircle2, Mail, Eye, EyeOff, ChevronRight } from 'lucide-react';
      ...
      <div className="hidden lg:flex w-1/2 relative bg-[#111113] items-center justify-center border-l border-white/5 p-12 overflow-y-auto">
        <div className="w-full max-w-md">
          ...
          <div className="mt-12 flex items-start gap-4 p-4 rounded-xl bg-white/5 border border-white/5">
             <div className="mt-0.5"><div className="w-5 h-5 rounded-full border border-blue-400 flex items-center justify-center text-blue-400 text-xs">✓</div></div>
             <div>
